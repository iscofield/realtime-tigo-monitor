...
1. Create `tigo-mqtt/` directory structure:
   ```bash
   mkdir -p tigo-mqtt/{data/{primary,secondary},run/{primary,secondary}}
   ```
...
### Project Files
- `/Volumes/docker/solar_tigo_viewer/docs/imports/primary.json` - Primary CCA node inventory
- `/Volumes/docker/solar_tigo_viewer/docs/imports/secondary.json` - Secondary CCA node inventory
- `/Volumes/docker/solar_tigo_viewer/docs/imports/translations.md` - Label translation mappings
- `/Volumes/docker/solar_tigo_viewer/docs/specs/2026-01-17-solar-panel-viewer.md` - Related viewer spec
