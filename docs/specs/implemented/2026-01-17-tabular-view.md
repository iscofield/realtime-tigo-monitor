...
### Project Files
- `/Volumes/docker/solar_tigo_viewer/frontend/src/App.tsx` - Main app component (add tab state)
- `/Volumes/docker/solar_tigo_viewer/frontend/src/hooks/useWebSocket.ts` - WebSocket hook (update PanelData interface)
- `/Volumes/docker/solar_tigo_viewer/backend/app/models.py` - Backend models (extend PanelData)
- `/Volumes/docker/solar_tigo_viewer/backend/app/mqtt_client.py` - MQTT client (extract additional fields)
- `/Volumes/docker/solar_tigo_viewer/tigo_docker/docker-compose.yml` - Add sidecar container
