...
### Project Files
- `/Volumes/docker/solar_tigo_viewer/layout.png` - Visual layout diagram
- `/Volumes/docker/solar_tigo_viewer/docs/imports/all` - Panel SN to label mapping
- `/Volumes/docker/solar_tigo_viewer/docs/imports/primary.json` - Primary system panel data
- `/Volumes/docker/solar_tigo_viewer/docs/imports/secondary.json` - Secondary system panel data
- `/Volumes/docker/solar_tigo_viewer/docs/imports/translations.md` - Panel relocation translations
