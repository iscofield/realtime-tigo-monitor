...
// Note: During initial load, canvas renders at 100% scale until configuration loads.
// This is intentional to show immediate feedback. For a loading spinner instead:
